...
class EventIndex extends Base
{
     ...
     *
     * TODO: (ugly) integer is used as we'd like an instance of the Utility_DayTime, but extbase
     *   would only return a DateTime Object in the extbase version shipped with TYPO3 4.4
     *
     * @var integer
     */
    protected $end;
