...
namespace Tx\CzSimpleCal\ViewHelpers\Format\Contrib;

/**
 * \Tx\CzSimpleCal\ViewHelpers\Format\Contrib\ChoiceFormat class file.
 *
...
/**
 * \Tx\CzSimpleCal\ViewHelpers\Format\Contrib\ChoiceFormat class.
 *
 * This is a port of symfony's sfChoiceFormat
 *
 * \Tx\CzSimpleCal\ViewHelpers\Format\Contrib\ChoiceFormat converts between ranges of numeric values and string
 * names for those ranges.
 *
 * A \Tx\CzSimpleCal\ViewHelpers\Format\Contrib\ChoiceFormat splits the real number line -Inf to +Inf into two or
 * more contiguous ranges. Each range is mapped to a string.
 * \Tx\CzSimpleCal\ViewHelpers\Format\Contrib\ChoiceFormat is generally used in a MessageFormat for displaying
 ...
 *
 *  $choice = new \Tx\CzSimpleCal\ViewHelpers\Format\Contrib\ChoiceFormat();
...
class ChoiceFormat
{
    ...
    public function isValid($number, $set)
    {
        ...
        if ($n < 3) {
            throw new \InvalidArgumentException(sprintf('Invalid set "%s".', $set));
        }
     ...
     * @return bool
     */
    protected function isValidSetNotation(
