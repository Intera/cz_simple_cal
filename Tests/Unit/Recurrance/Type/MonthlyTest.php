...
use Tx\CzSimpleCal\Recurrance\Type\Monthly;
...
class MonthlyTest extends UnitTestCase
{
    public function testRecurranceSubtypeAuto()
    {
        ...
        self::assertEquals(
            ...
            $return->next(),
            'correctly interpreted as second friday in month'
        );
    }
    ...
    /**
     * @expectedException \Tx\CzSimpleCal\Recurrance\BuildException
     */
    ...
    public function testRecurranceSubtypeFirstWeekdayOfMonth()
    {
        ...
        self::assertEquals(
            ...
            $return->next(),
            'no advance to next week if week starts with the required weekday'
        );
    }
    ...
    public function testRecurranceSubtypeLastWeekdayOfMonth()
    {
        ...
        self::assertEquals(
            ...
            $return->next(),
            'no advance to next week if week ends with the required weekday'
        );
    }
